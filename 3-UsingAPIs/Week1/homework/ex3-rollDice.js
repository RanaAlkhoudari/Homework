...
//What I understood from this exercise that with callback it prints the error message
//more than one time then continues to print the success message. Using promises
//avoids this problem, because promise either returns resolve(success) or reject(error).
